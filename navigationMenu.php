...
<nav id="nav">
  <div class="max-w-7xl mx-auto px-5 lg:px-8 flex items-center justify-between h-[66px]">
    <!--<a href="/sirtika-new/" class="font-display font-black text-xl tracking-widest gold-text">SIRTIKA™</a>-->
    <a href="/sirtika-new/" class="font-display font-black text-xl tracking-widest gold-text"><img src="img/sirtika-logo-100.png" alt="logo" style="height:55px;"></a>
    <ul class="hidden lg:flex items-center gap-8 text-sm font-medium text-nav">
      <li><a href="/sirtika-new/#framework" class="hover:text-gold-300 transition-colors">Framework</a></li>
      <li><a href="/sirtika-new/#programme" class="hover:text-gold-300 transition-colors">Programme</a></li>
      <li><a href="/sirtika-new/#offerings" class="hover:text-gold-300 transition-colors">Offerings</a></li>
  ...
  <div id="mob-menu" class="lg:hidden bg-dark-800/98 border-t border-maroon-700/20 px-6 py-5 space-y-4">
    <a href="/sirtika-new/#framework" onclick="toggleMob()" class="block text-nav hover:text-gold-300 py-2 border-b border-white/5 text-sm">Framework</a>
    <a href="/sirtika-new/#programme" onclick="toggleMob()" class="block text-nav hover:text-gold-300 py-2 border-b border-white/5 text-sm">Programme</a>
    <a href="/sirtika-new/#offerings" onclick="toggleMob()" class="block text-nav hover:text-gold-300 py-2 border-b border-white/5 text-sm">Offerings</a>
